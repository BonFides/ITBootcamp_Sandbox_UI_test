...
import sandbox_Objects.LogInPage;
import sandbox_Objects.RegPage;
import sandbox_utils.ReadExcel;
import sandbox_utils.ReadFile;

public class RegPageTestNG {
	String driverPath = "D:\\Installers\\chromedriver_win32\\chromedriver.exe";
	WebDriver driver;
	RegPage createAcc; 
	LogInPage login = new LogInPage(driver, ReadFile.readXPaths());
